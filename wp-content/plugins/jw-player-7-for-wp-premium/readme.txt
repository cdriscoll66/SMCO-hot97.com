...
* Bug: Error in get_poster_image() function if no featured image was set
* Bug: PHP Notice in Related posts option if no feature image was set
...
* Bug fix : Adding multiple videos at the same time not working with new posts


= 2.0.2 =
Release Date: 31 October 2019

* Bug fix : Carousel scrolling and inability to select some playlist elements
