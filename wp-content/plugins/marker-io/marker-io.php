...
function markerio_enqueue_admin_script($hook)
{
  ...
  wp_enqueue_style('markerio_style', plugin_dir_url(__FILE__) . 'dist/styles.css', [], '1.1.3');
  wp_enqueue_script('markerio_script', plugin_dir_url(__FILE__) . 'dist/scripts.js', [], '1.1.3');
}
...
function markerio_insert_code_snippet()
{
  ...
  if ($display_button) {
    ...
    window.markerConfig = {
      destination: '" . esc_js($options['destination_id']) . "',
      source: 'wordpress',
      ";
...
function markerio_register_settings()
{
  ...
  add_settings_field('destination_id', 'Destination ID', 'markerio_plugin_setting_destination_id', 'markerio_plugin');
  add_settings_field('destination_name', 'Destination name', 'markerio_plugin_setting_destination_name', 'markerio_plugin');
  add_settings_field('destination_display_name', 'Destination display name', 'markerio_plugin_setting_destination_display_name', 'markerio_plugin');
  add_settings_field('destination_platform', 'Destination platform', 'markerio_plugin_setting_destination_platform', 'markerio_plugin');
